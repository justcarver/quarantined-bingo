...
const potentialSquares = [
  ...
  `Aera grumbles about closets or cookies`,
  `Someone shouts "Don't jinx us!"`,
  `Someone asks for "Noods"`,
  `Someone yells about missing a pre-pot`,
